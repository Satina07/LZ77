    ...
    public static void main(String[] args) {
        ...
        try
        {
            if (args.length == 2) {
                ...
                if (file.exists()) {
                    if (args[0].toLowerCase().contains("c")) { // Сжатие
                    ...
                    } else if (args[0].toLowerCase().contains("d")) { // Распаковка
                        ...
                        System.out.println(args[0] + "является недопустимым аргументом");
                    }
                } else {
                    System.out.println(args[1] + "не является существующим файлом");
                }
            } else {
                System.out.println("Никаких аргументов представлено не было");
            }
        }
        catch (IOException e) {
